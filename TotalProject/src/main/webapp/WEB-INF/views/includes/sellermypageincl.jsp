...
<script src="../../resources/js/password.js"></script>
		...
		<div class="container" style="padding-bottom:200px">
            <div class="col-md-3">
                <div class="row"> 
                    <img src="../../resources/images/mypage/sellerimage.PNG">
                </div>
                <div class="row">
                ...
                <div class="row">
                	<form>
	                    ...
	                    <a href="/mypage/buyermypage?id=${member_s.id}">
	                    	<img src="../../resources/images/mypage/buyerchange.PNG">
	                    </a>
                    </form>
                </div>
                <br><br>
                ...
                <div class="col-md-11 col-md-push-1">
                    <div class="row">
                        <a href="/mypage/sellermypage?id=${member_s.id}" class="ba">내가 쓴 글</a>
                    </div>
                    <br>
                    <div class="row">
                        <a href="/mypage/sellerpostingcheck?id=${member_s.id}" class="ba"> 게시물 등록 여부</a>
                    </div>
                    <br>
                    <div class="row">
                        <a href="/mypage/sellerbuyercheck?id=${member_s.id}" class="ba"> 수강신청자 목록</a>
                    </div>
                    <br>
                    <div class="row">
                        <a href="sellerinfochange" class="ba"> 개인정보 수정</a>
                    </div>
                    <br>
                    <div class="row">
                        <a href="sellerpasschange" class="ba"> 비밀번호 변경</a>
                    </div>
                    <br>
                    <div class="row">
