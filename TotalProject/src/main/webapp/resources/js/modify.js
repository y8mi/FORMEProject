...
$(document).ready(function(){
		...
		//select박스 기본값
		var selectnumber = document.getElementById("categorynumber").value;
		console.log("sn = " + selectnumber);
		$('#categorySelected').val(selectnumber).prop("selected", true);
...
//다중선택리스트
  function categoryChange(e) {
		...
		var good_c = ["협의"];
		var target = document.getElementById("classhours");
